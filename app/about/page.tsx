...
export default function About() {
  ...
  const content = {
    ar: {
      ...
      title3: "ما نقدمه",
      title4: "من نخدم",
      p1: "أبجد التقنية هي فريق من المطورين المستقلين الملتزمين بشغف بإنشاء أدوات مبتكرة لتلبية احتياجات المجتمع الرقمي المتنوعة. تأسست المنظمة من قِبل مجموعة صغيرة من الأفراد المتشابهين في التفكير – @v0id_user و@huvnq و@musab على منصة X – ونحن متخصصون في بناء حلول عملية وذات جودة عالية تركز على الأمان والفائدة والموثوقية.\n\nفي أبجد التقنية، نحن أكثر من مجرد مطورين؛ نحن مجتمع من محبي التكنولوجيا يجمعنا التزام مشترك لإحداث فرق. فريقنا يجمع بين مهارات ومنظورات متنوعة لبناء أدوات تعالج التحديات الحقيقية التي يواجهها المطورون والمستخدمون على الإنترنت. نحن في المراحل الأولى من رحلتنا، لكن أهدافنا طموحة وواضحة.",
      ...
      p3: "تشمل مشاريعنا أدوات تركز على الأمان بالإضافة إلى أدوات للبروتوكولات الخاصة بسطح المكتب عن بُعد (RDP) وأكثر. أحد أبرز ابتكاراتنا هو كورد جارد، وهو حل لمكافحة الفيروسات المصغرة صُمم خصيصًا لاكتشاف التهديدات مثل سارقي بيانات ديسكورد وتليجرام. يركز عملنا على مساعدة المستخدمين والمطورين على الإنترنت في الحفاظ على الأمان والوعي والتمكين.",
      p4: "تم تصميم أدواتنا لمن يهتمون بالعالم الرقمي – سواء كانوا مطورين أو محبي التكنولوجيا أو مستخدمين يوميين يبحثون عن حلول أمنية موثوقة. إذا كنت شخصًا يقدّر الأمان الوظيفي على الإنترنت، فإن أبجد التقنية هنا لتزويدك بأدوات فعالة للتنقل في العالم الرقمي بثقة."
    },
    en: {
      title1: "Who Are We?",
